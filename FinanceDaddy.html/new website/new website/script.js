...
let userText = null;
const API_KEY = "7qhSCPl7uifXsMB96CAHglBPrEcOgKUO"; // Paste your API key here
...
const loadDataFromLocalstorage = () => {
    ...
    const defaultText = `<div class="default-text">
                            <h1>Finance Daddy GPT</h1>
                            <p>Start a conversation and explore the power of AI.<br> Your chat will be displayed here.</p>
                        </div>`
...
const getChatResponse = async (incomingChatDiv) => {
    const API_URL = "https://api.on-demand.io/chat/v1/sessions";
